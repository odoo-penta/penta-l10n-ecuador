...
class ReportPurchaseA2Wizard(models.TransientModel):
    ...
    def generate_xlsx_report(self):
        ...
        last_column = len(tax_groups) * 2 + 11
        ...
        worksheet.set_column(get_column_letter(last_column+4)+':'+get_column_letter(last_column+4), 25)
        worksheet.set_column(get_column_letter(last_column+5)+':'+get_column_letter(last_column+5), 37)
        worksheet.set_column(get_column_letter(last_column+6)+':'+get_column_letter(last_column+6), 25)
        # Encabezados
        ...
        headers += ['VALOR TOTAL', 'RETENCIÓN', 'CASILLA 104', 'DIARIO CONTABLE', 'FORMATO DE PAGO', 'REFERENCIA']
        # Mapear cabecera
