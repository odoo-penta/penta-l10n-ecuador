...
class TestViewsLoadContracts(TransactionCase):
    ...
    def test_views_and_actions_compile_contracts(self):
        ...
        self.env.ref("l10n_ec_rrhh.view_hr_contract_details")
        self.env.ref("l10n_ec_rrhh.view_hr_contract_previous")
        self.env.ref("l10n_ec_rrhh.view_hr_contract_other_parameters")

        # ============
        # CONFIG: IESS
        # ============
        self.env.ref("l10n_ec_rrhh.view_hr_iess_option_tree")
        self.env.ref("l10n_ec_rrhh.view_hr_iess_option_form")
        self.env.ref("l10n_ec_rrhh.action_hr_iess_option")
        self.env.ref("l10n_ec_rrhh.menu_hr_iess_option")

        # ======================
        # CONFIG: SECCIÓN CONTABLE
        # ======================
        self.env.ref("l10n_ec_rrhh.view_hr_account_section_tree")
        self.env.ref("l10n_ec_rrhh.view_hr_account_section_form")
        self.env.ref("l10n_ec_rrhh.action_hr_account_section")
        self.env.ref("l10n_ec_rrhh.menu_hr_account_section")

        # ======================
        # WORK LOCATION (branch_code)
        # ======================
        # Vistas propias (no dependen de XMLIDs nativos)
        self.env.ref("l10n_ec_rrhh.view_hr_work_location_tree_penta")
        self.env.ref("l10n_ec_rrhh.view_hr_work_location_form_penta")
